...
merge_package "https://github.com/sbwml/luci-app-mosdns.git" "v5" "luci-app-mosdns"
merge_package "https://github.com/sbwml/luci-app-mosdns.git" "v5" "mosdns"
merge_package "https://github.com/sbwml/luci-app-mosdns.git" "v5" "geo2txt"
